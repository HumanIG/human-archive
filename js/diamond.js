$(document).ready(function() {
	...
	if(window.mobilecheck() === false) {
		// $('#mini-site').css('opacity', '0');
		$('#mini-site').imagesLoaded(function() {
			placeLaptopSite();
			placeRibbon();
			placeAddressBar();

			$('#in-laptop, #address-bar, #diamond-overlay').animate({
				opacity: 1
			}, 1000);
		});
...
function placeRibbon() {
	...
	// These values were found through testing on the vector laptop image.
	var left_ratio = 0.0819984867075665;
	var top_ratio = 0.0000001;
	var width_ratio = 0.8286858309990664;
	var height_ratio = 0.8374378363228699;
